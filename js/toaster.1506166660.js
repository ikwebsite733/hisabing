...
function ($compile, $timeout, $sce, toasterConfig, toaster) {
  return {
    ...
    '<div  id="toast-container" ng-class="config.position">' +
        '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type"  ng-mouseover="stopTimer(toaster)">' +
          '<button class="toast-close-button" role="button" ng-click="remove(toaster.id)">Ã—</button>'+
